...
public final class BooleanArray extends TOP implements BooleanArrayFS {
 ...
 /* Internal - Constructor used by generator */
  ...
  /**
   * @see BooleanArrayFS#set(int , boolean)
   */
  ...
  /**
   * @see BooleanArrayFS#copyFromArray(boolean[], int, int, int)
   */
  ...
  /**
   * @see BooleanArrayFS#copyToArray(int, boolean[], int, int)
   */
  ...
  /**
   * @see BooleanArrayFS#copyToArray(int, String[], int, int)
   */
  ...
  /**
   * @see BooleanArrayFS#copyFromArray(String[], int, int, int)
   */
