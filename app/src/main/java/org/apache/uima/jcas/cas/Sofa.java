...
public class Sofa extends TOP implements SofaFS {
   ...
   */
	...
	/**
   * @see SofaFS#setLocalSofaData(FeatureStructure) This method is duplicated in
   ...
   */
	...
	/**
   * @see SofaFS#setLocalSofaData(String) This method is duplicated in
   *      SofaFSImpl. Any changes should be made in both places.
   */
	...
	/**
   * @see SofaFS#getLocalFSData() This method is duplicated in SofaFSImpl. Any
   ...
   */
	...
	/**
   * @see SofaFS#getLocalStringData() This method is duplicated in SofaFSImpl.
   ...
   */
	...
	/**
   * @see SofaFS#setRemoteSofaURI(String) This method is duplicated in
   *      SofaFSImpl. Any changes should be made in both places.
   */
