...
public final class StringArray extends TOP implements StringArrayFS {
 ...
 /* Internal - Constructor used by generator */
  ...
  /**
   * @see StringArrayFS#set(int, String)
   */
  ...
  /**
   * @see StringArrayFS#copyFromArray(String[], int, int, int)
   */
  ...
  /**
   * @see StringArrayFS#copyToArray(int, String[], int, int)
   */
