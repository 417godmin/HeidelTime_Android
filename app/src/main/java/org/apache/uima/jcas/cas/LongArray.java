...
public final class LongArray extends TOP implements LongArrayFS {
 ...
 /* Internal - Constructor used by generator */
  ...
  /**
   * @see LongArrayFS#copyFromArray(long[], int, int, int)
   */
  ...
  /**
   * @see LongArrayFS#copyToArray(int, long[], int, int)
   */
  ...
  /**
   * @see LongArrayFS#copyToArray(int, String[], int, int)
   */
  ...
  /**
   * @see LongArrayFS#copyFromArray(String[], int, int, int)
   */
