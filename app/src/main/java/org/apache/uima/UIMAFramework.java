...
public abstract class UIMAFramework {
  ...
  /**
   * Gets the {@link Logger} used by the UIMA framework. An application won't
  ...
  /**
   * Gets the {@link Logger} used by a particular Class, for example an
  ...
  /**
   * Creates a new {@link Logger}, which can be passed for example to the
  ...
  /**
   * Creates a new {@link UimaTimer}, which is used to collect performance
