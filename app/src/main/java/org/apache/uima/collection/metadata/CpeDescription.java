...
public interface CpeDescription extends MetaDataObject {
   ...
   * @return {@link CpeCollectionReader}
   * 
  ...
  /**
   * Returns a list of {@link CpeCollectionReader} instances
   * representing ALL defined CollectionReaders.
   * 
   * @return array of {@link CpeCollectionReader} instances.
   * 
   * @throws CpeDescriptorException tbd
   */
  ...
  /**
   * Returns a {@link CpeCasProcessors} instance containing
  ...
  /**
   * Appends a instance of {@link CpeCasProcessor} to the end of
   ...
   * 
   * @param aCasProcessor -
   *          instance of {@link CpeCasProcessor} to add.
   * @throws CpeDescriptorException tbd
   */
  public void addCasProcessor(CpeCasProcessor aCasProcessor) throws CpeDescriptorException;

  /**
   * Adds a instance of {@link CpeCasProcessor} at a specified
   * location in the list of CPE CasProcessors. If the index is greater than the list size, the new
   * {@link CpeCasProcessor} instance is appended to the list.
   * 
   * @param index -
   *          insertion point for the {@link CpeCasProcessor}
   * @param aCasProcessor -
   *          CasProcessor to add
   * 
   * @throws CpeDescriptorException tbd
   ...
   * 
   * @return {@link CpeResourceManagerConfiguration}
   */
