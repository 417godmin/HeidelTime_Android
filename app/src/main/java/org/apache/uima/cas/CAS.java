 ...
 * {@link CAS#createSofa CAS.createSofa()} to instantiate a Sofa feature
 ...
 * <p>
 * Use {@link CAS#getView(String)} or
 * {@link CAS#getView(SofaFS)} to obtain a view of a particular Sofa in the CAS.
...
public interface CAS extends AbstractCas {
   ...
   * {@link FSMatchConstraint FSMatchConstraints}.
   * 
  ...
  /**
   * Wrap a standard Java {@link ListIterator ListIterator} around an FSListIterator. Use
