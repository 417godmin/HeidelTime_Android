...
/**
 * Implementation of the {@link ArrayFS ArrayFS} interface.
 * 
 * 
 */
public class ArrayFSImpl extends CommonArrayFSImpl implements ArrayFS {
  ...
  /**
   * @see ArrayFS#set(int, FeatureStructure)
   */
  ...
  /**
   * @see ArrayFS#copyFromArray(FeatureStructure[], int,
   *      int, int)
   */
  ...
  /**
   * @see ArrayFS#copyToArray(int, FeatureStructure[], int,
   *      int)
   */
