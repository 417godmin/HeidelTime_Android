...
/**
 * Implementation of the {@link IntArrayFS IntArrayFS} interface.
 * 
 * 
 */
public class IntArrayFSImpl extends CommonArrayFSImpl implements IntArrayFS {
  ...
  /**
   * @see IntArrayFS#copyFromArray(int[], int, int, int)
   */
  ...
  /**
   * @see IntArrayFS#copyToArray(int, int[], int, int)
   */
  ...
  /**
   * @see IntArrayFS#copyToArray(int, String[], int, int)
   */
  ...
  /**
   * @see IntArrayFS#copyFromArray(String[], int, int, int)
   */
