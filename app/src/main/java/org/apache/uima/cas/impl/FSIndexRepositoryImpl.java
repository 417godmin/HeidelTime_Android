...
//        System.out.println("Debug - got iterator invalid before all items filled, i = " + i + ", size = " + flatArray.length);
  ...
  private class PointerIterator implements IntPointerIterator, LowLevelIterator {
    ...
    /**
     * @see IntPointerIterator#moveTo(int)
     */
...
//        }
  ...
  class IndexImpl<T extends FeatureStructure> implements FSIndex<T>, FSIndexImpl {
    ...
    /**
     * @see FSIndex#getIndexingStrategy()
     */
    @Override
...
//    }
    ...
    /**
     * @see FSIndex#compare(FeatureStructure, FeatureStructure)
     */
    @Override
    ...
    /**
     * @see FSIndex#contains(FeatureStructure)
     */
    @Override
    ...
    /**
     * @see FSIndex#find(FeatureStructure)
     */
    @Override
    ...
    /**
     * @see FSIndex#iterator(FeatureStructure)
     */
   @Override
   public FSIterator<T> iterator(FeatureStructure fs) {
    ...
    /**
     * @see FSIndex#withSnapshotIterators()
     */
    @Override
...
//    }
  ...
  /**
   * @see FSIndexRepositoryMgr#commit()
   */
  public void commit() {
  ...
  /**
   * @see FSIndexRepositoryMgr#createIndex(FSIndexComparator, String)
   */
...
//  private BitSet[] createflattenedIndexValid()
  ...
  /**
   * @see FSIndexRepositoryMgr#getIndexes()
   */
  ...
  /**
   * @see FSIndexRepositoryMgr#getLabels()
   */
  ...
  /**
   * @see FSIndexRepositoryMgr#createComparator()
   */
  ...
  /**
   * @see FSIndexRepositoryMgr#isCommitted()
   */
  ...
  /**
   * @see FSIndexRepositoryMgr#createIndexComparator()
   */
  // public FSIndexComparator createIndexComparator() {
  // return new FSIndexComparatorImpl(this.cas);
  // }
  /**
   * @see FSIndexRepositoryMgr#createIndex(FSIndexComparator,
   *      String)
   */
  ...
  /**
   * @see org.apache.uima.cas.FSIndexRepository#addFS(FeatureStructure)
   */
...
//    indexUpdated(typeCode);
  ...
  /**
   * @see org.apache.uima.cas.FSIndexRepository#removeFS(FeatureStructure)
   */
