...
public class FSIntArrayIndex<T extends FeatureStructure> extends FSLeafIndexImpl<T> {
  ...
  /**
   * @see FSLeafIndexImpl#init(FSIndexComparator)
   */
  ...
  /**
   * @see FSLeafIndexImpl#refIterator()
   */
  ...
  /**
   * @see FSLeafIndexImpl#refIterator(int)
   */
  ...
  /**
   * @see FSLeafIndexImpl#deleteFS(FeatureStructure)
   */
