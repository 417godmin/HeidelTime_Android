...
public class CASMgrSerializer implements Serializable {
   ...
   * {@link FSIndex#SORTED_INDEX SORTED_INDEX},
   * {@link FSIndex#SET_INDEX SET_INDEX} and
   * {@link FSIndex#BAG_INDEX BAG_INDEX}.
   ...
   * {@link FSIndexComparator#STANDARD_COMPARE STANDARD_COMPARE} and
   * {@link FSIndexComparator#REVERSE_STANDARD_COMPARE REVERSE_STANDARD_COMPARE}.
   */
