...
//@formatter:on
  ...
  private void getAttributesFromBeans(final Class<? extends MetaDataObject_impl> clazz) {
    ...
    for (Map.Entry<String, Method> entry : getters.entrySet()) {
      ...
      MetaDataAttr mda = new MetaDataAttr(propName, getter, setter, propClass);
    ...
    class2attrsMap.putIfAbsent(clazz, resultList.toArray(new MetaDataAttr[0]));
    class2attrsMapUnfiltered.putIfAbsent(clazz, resultListUnfiltered.toArray(new MetaDataAttr[0]));
  }
