 ...
 * {@link ResourceManager} and may be shared between components. This
 * object has four properties:
 * <ul>
 * <li>A name, used to identify the resource.</li>
 * <li>A textual description of the resource.</li>
 * <li>A {@link ResourceSpecifier} that describes how to create the
...
public interface ExternalResourceDescription extends MetaDataObject {
   ...
   * extend {@link SharedResourceObject} as well as the interface specified
   ...
   * {@link SharedResourceObject} as well as the interface specified by
