...
/**
 * Reference implementation of {@link URISpecifier}.
 * 
 * 
 */
public class URISpecifier_impl extends MetaDataObject_impl implements URISpecifier {
  ...
  /**
   * @see URISpecifier#setUri(String)
   */
  @Override
  ...
  /**
   * @see URISpecifier#setProtocol(String)
   */
  @Override
  ...
  /**
   * @see URISpecifier#setTimeout(Integer)
   */
  @Override
