...
public final class ResultSpecification_impl extends MetaDataObject_impl implements
  ...
  /**
   * @see ResultSpecification#getResultTypesAndFeatures()
   */
  ...
  /**
   * @see ResultSpecification#getResultTypesAndFeatures(String)
  ...
  /**
   * @see ResultSpecification#setResultTypesAndFeatures(TypeOrFeature[])
   */
  ...
  /**
   * @see ResultSpecification#addResultTypeOrFeature(TypeOrFeature)
   */
  ...
  /**
   * @see ResultSpecification#addResultType(String,
   *      boolean)
   */
  ...
  /**
   * @see ResultSpecification#addResultFeature(String)
   */
  ...
  /**
   * @see ResultSpecification#compile(TypeSystem)
  ...
  /**
   * @see ResultSpecification#containsType(String)
   */
  ...
  /**
   * @see ResultSpecification#containsType(String, String)
   * method:
   *   
  ...
  /**
   * @see ResultSpecification#containsFeature(String)
   */
  ...
  /**
   * @see ResultSpecification#containsFeature(String, String)
   */
  ...
  /**
   * @see ResultSpecification#addCapabilities(Capability[])
   */
  ...
  /**
   * @see ResultSpecification#removeTypeOrFeature(TypeOrFeature)
