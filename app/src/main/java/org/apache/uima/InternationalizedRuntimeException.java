 ...
 * up in a locale-specific {@link ResourceBundle ResourceBundle} to find the actual
 * message associated with this exception.
 * <p>
 * This class also supports arguments to messages. The full message will be constructed using the
 * {@link MessageFormat MessageFormat} class. For more information on
...
public class InternationalizedRuntimeException extends RuntimeException {
   ...
   *          {@link MessageFormat MessageFormat} class.
   * @param aArguments
   ...
   * exception's {@link ResourceBundle ResourceBundle} to get the locale-specific message
   * for this exception.
   * 
